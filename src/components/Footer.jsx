...
export default function Footer({ onAboutClick }) {
  return (
    <footer className="relative z-20 border-t pt-16 pb-10 px-4 sm:px-6" style={{ borderColor: "rgba(255,255,255,0.1)", background: "linear-gradient(to bottom, #09090b, #000000)", isolation: "isolate" }}>
