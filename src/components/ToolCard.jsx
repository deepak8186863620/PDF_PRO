...
export default function ToolCard({ name, description, icon: Icon, color, category, onClick }) {
  return (
    <motion.button
      ...
      onClick={onClick}
      className="group relative w-full text-left rounded-[20px] p-6 cursor-pointer overflow-hidden focus:outline-none focus-ring bg-[#111111] border border-[#2a2a2a] hover:bg-[#18181A] transition-colors duration-300"
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex items-start justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-semibold uppercase tracking-wider text-zinc-500 bg-white/5 border border-white/5 px-2.5 py-1 rounded-full">
              {category}
            </span>
        ...
        <div className="space-y-1.5 mb-8">
          ...
          <p className="text-zinc-400 text-[12.5px] leading-relaxed line-clamp-2 pr-2">
            {description}
          </p>
        </div>
        ...
        <div className="mt-auto flex items-center justify-between">
          <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-600 group-hover:text-white transition-colors duration-300">
            Open Tool
          </span>
