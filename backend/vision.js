 ...
 */
export async function performOCR(imageContent) {
  try {
 ...
 */
export async function performStructuredOCR(imageContent) {
  try {
    const content = toBase64(imageContent);
    ...
    console.log('Calling Vision API URL (Structured):', VISION_API_URL.split('key=')[0] + 'key=HIDDEN');
